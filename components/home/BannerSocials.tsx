...
const HomeBannerSocials = () => {
  return (
    <div className="flex justify-center gap-8 mt-6 lg:justify-start">
      <a
        className={classes}
      ...
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          className="transition w-7 h-7 fill-black-800 group-hover:fill-black-900 dark:fill-black-800 dark:group-hover:fill-black-900"
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      <a
        ...
        href="https://twitter.com/AdamJArling"
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
...
export default HomeBannerSocials;
